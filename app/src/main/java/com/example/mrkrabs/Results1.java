...
public class Results1 extends Activity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestText0 = findViewById(R.id.JSONResults);
        ...
        CityCosts = findViewById(R.id.JSONResults12);
        ...
        CityCosts.setText("Costs in " + City2);
    ...
    public void onClick(View a){
        ...
        CreateData();
        Calculations(Data);
        TestText0.setText(String.valueOf(((GlobalClass) this.getApplication()).getExpectedSalary()));
