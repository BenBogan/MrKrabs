...
public class Results1 extends Activity implements OnClickListener{
    ...
    public void onClick(View a){
        ...
        TestText2.setText(StringOutputs[0]);
        TestText3.setText(StringOutputs[0]);
        TestText4.setText(StringOutputs[0]);
        TestText5.setText(StringOutputs[0]);
        TestText6.setText(StringOutputs[0]);
        TestText7.setText(StringOutputs[0]);
        TestText8.setText(StringOutputs[0]);
        TestText9.setText(StringOutputs[0]);
        TestText10.setText(StringOutputs[0]);
    }
    ...
    private void Calculations(float[] Inputs){
        ...
        Outputs[2]=Inputs[4]*(AwayFloat[5]+AwayFloat[6])/(AwayFloat[5]+AwayFloat[6]);
        if(Inputs[6]==0){
        ...
        Outputs[7]=Inputs[10]*(AwayFloat[19]+AwayFloat[20])/(AwayFloat[19]+AwayFloat[20]);
        Outputs[8]=Inputs[11]*(AwayFloat[21]+AwayFloat[22])/(AwayFloat[21]+AwayFloat[22]);
        Outputs[9]=Inputs[12]*(AwayFloat[22]+AwayFloat[23])/(AwayFloat[22]+AwayFloat[23]);
        for(int i =0; i<24;i++){
